        ...
        <div class="container">
            ...
            <div class="panel panel-default">
                <div class="panel panel-heading">
                    <strong><h4>Validação das Disciplinas<h4</strong>
                </div>
                <div class="panel panel-body">
                 ...
                 while ($cliente = mysqli_fetch_assoc($limite)) {
                            ...
                            <div class='form-group'>                                                                     
                                <a href='formAutorizacao.php?id=$id' class='btn btn-info'>Verificar</a>             
                             </td>
                             </div> 
                                   </tr>";
                 }         
...
<?php
 ...
 ?> 
                             ...
                             <a href='listasolicitacao.php' class="btn btn-default">Listar Solicitações</a>
